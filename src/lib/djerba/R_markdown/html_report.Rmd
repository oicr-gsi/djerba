...
<table width="100%">
  <tr>
    ...
    <td width="37%"><strong>Report ID:</strong> `r paste0(clinicalData$TUMOR_SAMPLE_ID, "-v", clinicalData$REPORT_VERSION)`</td>
  </tr>
  <tr>
...
<table width="100%">
  ...
  <tr>
    <td width="50%"><strong>Tumour Sample ID:</strong> `r clinicalData$TUMOR_SAMPLE_ID`</td>
    <td width="50%"><strong>Blood Sample ID:</strong> `r clinicalData$BLOOD_SAMPLE_ID`</td>
  </tr>
</table>
<div id="header1">
...
ggplot(tmb_data, aes(TCGA.tmb)) + geom_density(aes(color = "All TCGA"), fill = "grey",
  ...
  legend.position = c(1,0.8), plot.margin = unit(c(2,3,0,2), "lines")) + scale_color_manual(name = "Cohort", breaks = c("All TCGA",
...
ggplot(MAF) + geom_density(aes(x = tumor_vaf), fill = "grey", alpha = 0.5) + geom_rug(aes(x = tumor_vaf,
  ...
  0), limit = c(0, 1)) + scale_y_continuous(expand = c(0, 0)) + theme(plot.margin = unit(c(2,3,0,2), "lines"))
