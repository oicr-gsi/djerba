...
class main(plugin_base):
    ...
    def extract(self, config):
        ...
        if gene_pair_fusions is not None:
            ...
            results = {
                ...
                fc.CLINICALLY_RELEVANT_VARIANTS: distinct_oncogenic_genes,
                fc.BODY: rows
            }
        else:
            results = {
    ...
    def specify_params(self):
        ...
        enscon_path = os.path.join(data_dir, fc.ENTRCON_NAME)
        self.set_ini_default(fc.ENTREZ_CONVERSION_PATH, enscon_path)
