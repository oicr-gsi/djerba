...
class TestSupplementaryPluginBody(PluginTester):
    ...
    def testPwgsSupplementary(self):
        ...
        params = {
            ...
            self.MD5: '6e1a96a5d152dcca10a3ce04fab773bc'
        }
    ...
    def testTarSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: 'fd7bba3bea81f8d7c6264c8c461566a0'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testTarFailSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: '9fffd539eb01d52ab7b9940b17c1cee7'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgtsSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: '2a6c0c57047f70f2c351e8e87d0e00d5'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgtsFailSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: 'aaf8d3a7b456795527e81cacaefad334'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgts40XSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: '129318a9fbf408de549a4e7fcc4e73f7'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgts40XFailSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: 'a02be9a72656083ebef67cac62471394'
        }
        self.run_basic_test(test_source_dir, params)
