...
class TestSupplementaryPluginBody(PluginTester):
    ...
    def testTarResearchSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: '943742a14ace7d9be2dd0822e2de5aa0'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testTarFailSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: '5a5e66b242043e1305a0393142e44bcc'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgtsSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: 'd94c03fbc5f3e29baa5b8bb9fc4c05b5'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgtsFailSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: '311c08db6926efeeec61f0cbbc514fd9'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgtsResearchSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: '06d9c17330fcfe848ccfee6431592c00'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgts40XSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: 'ba86e94ef6e4bb10f116a2ecca5f9c6d'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgts40XResearchSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: '5613d423cb56744ba0a757fef82adf92'
        }
        self.run_basic_test(test_source_dir, params)
    ...
    def testWgts40XFailSupplementary(self):
        ...
        params = {
            ...
            self.JSON: json_location,
            self.MD5: '656043c5862f21490d7c1fe6068b6dd4'
        }
        self.run_basic_test(test_source_dir, params)
