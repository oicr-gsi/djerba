...
def get_parser():
    ...
    publish_parser.add_argument('-u', '--unit', metavar='UNIT', help='Analysis unit identifier; optional')
    ...
    draft_parser.add_argument('-H', '--html', metavar='PATH', help='Path for HTML output; optional, defaults to ${ANALYSIS_UNIT}.html in the input directory')
    ...
    all_parser.add_argument('-D', '--dir', metavar='DIR', help='Directory for extracted metrics output; if not given, metrics are written to a temporary directory and discarded')
    ...
    all_parser.add_argument('-p', '--pdf-dir', metavar='DIR', required=True, help='Directory for PDF output')
    ...
    all_parser.add_argument('-u', '--unit', metavar='UNIT', help='Analysis unit identifier; optional')
