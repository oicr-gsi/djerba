...
from djerba_modular.plugin_wise.configure import configurer
from djerba_modular.plugin_wise.extract import extractor
from djerba_modular.plugin_wise.render import renderer
...
class main(main_core):
    ...
    def configure(self, ini_path, work_dir):
        ...
        new_cp = configurer(cp, self.log_level, self.log_path).run(out_path)
